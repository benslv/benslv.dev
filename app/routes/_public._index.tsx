	...
	return (
		<Container>
			<div className="flex flex-col gap-y-6">
				...
				<section>
					<h2 className="mb-2 text-2xl font-medium text-zinc-800">
						Experience
					</h2>
					<ul className="ml-4 list-disc space-y-2 marker:text-zinc-300">
						<li>
							...
							<p>
								Software Engineer II, developing high-performance,
								cross-platform applications for Max with Solid and LightningJS.
							</p>
						</li>
						<li>
							<Link
							...
							<p>
								Enterprise IT Intern, implementing a component-driven
								architecture in React for Arm Developer Community, and writing
								backend Azure policies to introduce new functionality to Arm
								Account.
							</p>
						</li>
					</ul>
